...
![Astroknot whole puzzle](astroknot_all_pic.jpg)
...
![circumvent stuff](astroknot_circumvent_stuff_all-303x1024.png)
...
![imagining deformed puzzle](astroknot_deformed_wire_shape.png)
...
![compound move](astroknot_compound_move_full_sequence.png)
...
![overall sequence](astroknot_overall_sequence.png)

In the actual puzzle, this looks like the following.

![sequence 1](astroknot_strategy_pic1.png)
...
![sequence 1 to 2](astroknot_1_to_2.png)

Let's look at that sequence in a little more detail.

![circumvent 0](circumvent_pic_0.png)

![circumvent 1](circumvent_pic_1.png)

![circumvent 2](circumvent_pic_2.png)

![circumvent 3](circumvent_pic_3.png)

![circumvent 4](circumvent_pic_4.png)

![circumvent 5](circumvent_pic_5.png)

![circumvent 6](circumvent_pic_6.png)

![circumvent 71](circumvent_pic_71.png)

Then to go from step 2 to step 3, we do essentially the same thing, but just through the other inner wire loop.

![2 to 4](astroknot_2_to_41-496x1024.png)

In detail, we have the following,

![2 to 4 part 1](astroknot_2_to_4_1.png)

![2 to 4 part 2](astroknot_2_to_4_2.png)

![2 to 4 part 3](astroknot_2_to_4_3.png)

![2 to 4 part 4](astroknot_2_to_4_4.png)

![2 to 4 part 5](astroknot_2_to_4_5.png)

![2 to 4 part 6](astroknot_2_to_4_6.png)

![2 to 4 part 7](astroknot_2_to_4_7.png)

![2 to 4 part 8](astroknot_2_to_4_81.png)

![2 to 4 part 9](astroknot_2_to_4_91.png)
...
![final stretch 1](astroknot_final_stretch_1.png)

![final stretch 2](astroknot_final_stretch_2.png)

![final stretch 3](astroknot_final_stretch_3.png)

![final stretch 4](astroknot_final_stretch_4.png)

![astroknot solved](astroknot_solved.png)
